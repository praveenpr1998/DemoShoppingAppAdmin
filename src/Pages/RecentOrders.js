...
class RecentOrders extends Component {
                                    ...
                                    this.state.groupedProducts[key].map((product) => {
                                        return(
                                            <tr>
                                                ...
                                                <td className='price-column'>{product['Quantity'] * product['Price']}</td>
                                            </tr>
                                        );
                                    })
                                }
    ...
    // render() method
    render() {
        console.log("s",this.state.order.length)
        if(this.state.order.length===undefined){
            console.log("true")
        }
        return(
